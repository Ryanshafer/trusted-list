...
export const SetReminderDialog = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-sm p-0 gap-0 overflow-hidden rounded-2xl [&>button]:hidden">

        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4">
          <div className="flex flex-col gap-0">
            <h2 className="font-serif text-2xl font-normal leading-8">Set a reminder</h2>
            <p className="text-sm text-muted-foreground">
              Follow up on{" "}
              <span className="font-medium text-foreground">{requesterName}'s</span>{" "}
              request.
            </p>
          </div>
          <DialogClose asChild>
